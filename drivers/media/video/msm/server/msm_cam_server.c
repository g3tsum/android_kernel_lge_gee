		...
		bool valid_prio, int cmd, void *arg)
{
	...
	pr_info("%s: cmd: %d, (IOC_NR)cmd %d\n", __func__, cmd, _IOC_NR(cmd));

	switch (cmd) {
	case MSM_CAM_V4L2_IOCTL_GET_CAMERA_INFO:
pr_info("XXXX: %s: MSM_CAM_V4L2_IOCTL_GET_CAMERA_INFO",__func__);
...
pr_info("XXXX: %s: MSM_CAM_V4L2_IOCTL_GET_CONFIG_INFO",__func__);
...
pr_info("XXXX: %s: MSM_CAM_V4L2_IOCTL_GET_MCTL_INFO, cmd: %d\n",__func__,cmd);
...
pr_info("XXXX: %s: MSM_CAM_V4L2_IOCTL_CTRL_CMD_DONE",__func__);
...
pr_info("XXXX: %s: MSM_CAM_V4L2_IOCTL_GET_EVENT_PAYLOAD",__func__);
...
pr_info("XXXX: %s: MSM_CAM_IOCTL_SEND_EVENT",__func__);

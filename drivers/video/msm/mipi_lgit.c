...
static int mipi_lgit_lcd_on(struct platform_device *pdev)
{
	...
	MIPI_OUTP(MIPI_DSI_BASE + 0x38, 0x10000000);
		...
		cmdreq.cmds =	mipi_lgit_pdata->power_on_set_1;
		cmdreq.cmds_cnt = ARRAY_SIZE(mipi_lgit_pdata->power_on_set_1);
		cmdreq.flags = CMD_REQ_COMMIT;
		cmdreq.rlen = 0;
		cmdreq.cb = NULL;
		mipi_dsi_cmdlist_put(&cmdreq);
		memset(&cmdreq, 0, sizeof(cmdreq));
		cmdreq.cmds =	mipi_lgit_pdata->power_on_set_size_1;
		cmdreq.cmds_cnt = ARRAY_SIZE(mipi_lgit_pdata->power_on_set_size_1);
		cmdreq.flags = CMD_REQ_COMMIT;
		cmdreq.rlen = 0;
		cmdreq.cb = NULL;
		mipi_dsi_cmdlist_put(&cmdreq);
	...
	if(!skip_init){
		MIPI_OUTP(MIPI_DSI_BASE + 0x38, 0x10000000);
		memset(&cmdreq, 0, sizeof(cmdreq));
		cmdreq.cmds =	mipi_lgit_pdata->power_on_set_2;
		cmdreq.cmds_cnt = ARRAY_SIZE(mipi_lgit_pdata->power_on_set_2);
		cmdreq.flags = CMD_REQ_COMMIT;
		cmdreq.rlen = 0;
		cmdreq.cb = NULL;
		mipi_dsi_cmdlist_put(&cmdreq);
		memset(&cmdreq, 0, sizeof(cmdreq));
		cmdreq.cmds =	mipi_lgit_pdata->power_on_set_size_2;
		cmdreq.cmds_cnt = ARRAY_SIZE(mipi_lgit_pdata->power_on_set_size_2);
		cmdreq.flags = CMD_REQ_COMMIT;
		cmdreq.rlen = 0;
		cmdreq.cb = NULL;
		mipi_dsi_cmdlist_put(&cmdreq);
	...
	MIPI_OUTP(MIPI_DSI_BASE + 0x38, 0x10000000);
		memset(&cmdreq, 0, sizeof(cmdreq));
		cmdreq.cmds =	mipi_lgit_pdata->power_on_set_3;
		cmdreq.cmds_cnt = ARRAY_SIZE(mipi_lgit_pdata->power_on_set_3);
		cmdreq.flags = CMD_REQ_COMMIT;
		cmdreq.rlen = 0;
		cmdreq.cb = NULL;
		mipi_dsi_cmdlist_put(&cmdreq);
		memset(&cmdreq, 0, sizeof(cmdreq));
		cmdreq.cmds =	mipi_lgit_pdata->power_on_set_size_3;
		cmdreq.cmds_cnt = ARRAY_SIZE(mipi_lgit_pdata->power_on_set_size_3);
		cmdreq.flags = CMD_REQ_COMMIT;
		cmdreq.rlen = 0;
		cmdreq.cb = NULL;
		mipi_dsi_cmdlist_put(&cmdreq);
...
static int mipi_lgit_lcd_off(struct platform_device *pdev)
{
	...
	MIPI_OUTP(MIPI_DSI_BASE + 0x38, 0x10000000);
		memset(&cmdreq, 0, sizeof(cmdreq));
		cmdreq.cmds =	mipi_lgit_pdata->power_off_set_1;
		cmdreq.cmds_cnt = ARRAY_SIZE(mipi_lgit_pdata->power_off_set_1);
		cmdreq.flags = CMD_REQ_COMMIT;
		cmdreq.rlen = 0;
		cmdreq.cb = NULL;
		mipi_dsi_cmdlist_put(&cmdreq);
		memset(&cmdreq, 0, sizeof(cmdreq));
		cmdreq.cmds =	mipi_lgit_pdata->power_off_set_size_1;
		cmdreq.cmds_cnt = ARRAY_SIZE(mipi_lgit_pdata->power_off_set_size_1);
		cmdreq.flags = CMD_REQ_COMMIT;
		cmdreq.rlen = 0;
		cmdreq.cb = NULL;
		mipi_dsi_cmdlist_put(&cmdreq);
	...
	MIPI_OUTP(MIPI_DSI_BASE + 0x38, 0x10000000);
		memset(&cmdreq, 0, sizeof(cmdreq));
		cmdreq.cmds =	mipi_lgit_pdata->power_off_set_2;
		cmdreq.cmds_cnt = ARRAY_SIZE(mipi_lgit_pdata->power_off_set_2);
		cmdreq.flags = CMD_REQ_COMMIT;
		cmdreq.rlen = 0;
		cmdreq.cb = NULL;
		mipi_dsi_cmdlist_put(&cmdreq);
		memset(&cmdreq, 0, sizeof(cmdreq));
		cmdreq.cmds =	mipi_lgit_pdata->power_off_set_size_2;
		cmdreq.cmds_cnt = ARRAY_SIZE(mipi_lgit_pdata->power_off_set_size_2);
		cmdreq.flags = CMD_REQ_COMMIT;
		cmdreq.rlen = 0;
		cmdreq.cb = NULL;
		mipi_dsi_cmdlist_put(&cmdreq);

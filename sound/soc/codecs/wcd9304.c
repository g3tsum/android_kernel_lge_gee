...
#include <uapi/linux/mfd/wcd9xxx/wcd9304_registers.h>
...
static const struct snd_kcontrol_new sitar_snd_controls[] = {
	...
	SOC_SINGLE_SX_TLV("RX1 Digital Volume", SITAR_A_CDC_RX1_VOL_CTL_B2_CTL,
		0, -84, 40, digital_gain),
	SOC_SINGLE_SX_TLV("RX2 Digital Volume", SITAR_A_CDC_RX2_VOL_CTL_B2_CTL,
		0, -84, 40, digital_gain),
	SOC_SINGLE_SX_TLV("RX3 Digital Volume", SITAR_A_CDC_RX3_VOL_CTL_B2_CTL,
		0, -84, 40, digital_gain),

	SOC_SINGLE_SX_TLV("DEC1 Volume", SITAR_A_CDC_TX1_VOL_CTL_GAIN, 0, -84, 40,
		digital_gain),
	SOC_SINGLE_SX_TLV("DEC2 Volume", SITAR_A_CDC_TX2_VOL_CTL_GAIN, 0, -84, 40,
		digital_gain),
	SOC_SINGLE_SX_TLV("DEC3 Volume", SITAR_A_CDC_TX3_VOL_CTL_GAIN, 0, -84, 40,
		digital_gain),
	SOC_SINGLE_SX_TLV("DEC4 Volume", SITAR_A_CDC_TX4_VOL_CTL_GAIN, 0, -84, 40,
		digital_gain),

	SOC_SINGLE_SX_TLV("IIR1 INP1 Volume", SITAR_A_CDC_IIR1_GAIN_B1_CTL, 0, -84,
		40, digital_gain),
	SOC_SINGLE_SX_TLV("IIR1 INP2 Volume", SITAR_A_CDC_IIR1_GAIN_B2_CTL, 0, -84,
		40, digital_gain),
	SOC_SINGLE_SX_TLV("IIR1 INP3 Volume", SITAR_A_CDC_IIR1_GAIN_B3_CTL, 0, -84,
		40, digital_gain),
	SOC_SINGLE_SX_TLV("IIR1 INP4 Volume", SITAR_A_CDC_IIR1_GAIN_B4_CTL, 0, -84,
		40, digital_gain),
